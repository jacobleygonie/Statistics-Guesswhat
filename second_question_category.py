...
class SecondQuestionCategory(AbstractPlotter):
    def __init__(self, path, games, logger, suffix):
        super(SecondQuestionCategory, self).__init__(path, self.__class__.__name__, suffix)
        ...
        plt.title("Is a category used as a word in the second question ? Is this category is in the image ? Success ? ")
