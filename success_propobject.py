...
class SuccessPropObject(AbstractPlotter):
    def __init__(self, path, games, logger, suffix):
        super(SuccessPropObject, self).__init__(path, self.__class__.__name__, suffix)
        ...
        for game in games:
            ...
            area_list.append(float(game.object.area)*100/(game.image.width*game.image.height))
        ...
        #f.set_xlim(-0.5,8.5)
        #f.set_ylim(0,30000)
        f.set_xlabel("object area / image area", {'size':'14'})
