...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 28 20:26:42 2018
...
class RaretyVSTimeWitoutBuzzWords(AbstractPlotter):
      
    def __init__(self, path, games, logger, suffix):
        
        super(RaretyVSTimeWitoutBuzzWords, self).__init__(path, self.__class__.__name__, suffix)
        stopwords = ["a", "an", "is", "it", "the", "does", "do", "are", "you", "that",
             "they", "doe", "this", "there", "hi", "his", "her", "its", "picture", "can", "he", "she", "bu", "us", "photo","in","on","left","right","front","person","middle","half","of","food"]
        questions = []
