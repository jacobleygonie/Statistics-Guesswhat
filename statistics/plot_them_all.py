...
from guesswhat.statistics.SuccessVSNumber_last_yes import *
from guesswhat.statistics.RaretyOfWordsOverTime import *
from guesswhat.statistics.successVSrepetition import *
from guesswhat.statistics.SuccessVSWordRepetition import *
from guesswhat.statistics.CommonAndRareWordUsage import *
from guesswhat.statistics.used_words import *
from guesswhat.statistics.unused_words import *
from guesswhat.statistics.tfidf import *
from guesswhat.statistics.tfidf2 import *
from guesswhat.statistics.RaretyVStime_WithoutBuzzWords import *
...
prototypes = [
    ...
    QuestionVsDialogue,
    WordCloud,
    SuccessNumberLastYes,
    RaretyVSTime,
    RaretyVSTimeWitoutBuzzWords,
    SuccessNoRepetitions,
    SuccessNoWordRepetitions,
    WordUsage,
    MostUsedWords,
    LessUsedWords,
    tfidf
